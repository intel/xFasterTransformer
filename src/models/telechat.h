...
class TeleChatLLM
    : public CommonDecoder<Attention<WeiT, TeleChatRotaryEmbedding, RmsNorm, typename TypeSelector<WeiT>::InType,
              ...
              KVCacheT> {
public:
    TeleChatLLM(const std::string &modelPath);
    ~TeleChatLLM();
...
REGISTER_MODEL(TeleChatLLM, telechat)