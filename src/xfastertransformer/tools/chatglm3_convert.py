...
class ChatGLM3Convert(BaseModelConvert):
    """
    ...
    def split_and_convert(self, input_dir, output_dir, dtype, processes):
        ...
        try:
            ...
            config["chatglm3"]["has_post_decoder_layernorm"] = (
            ...
            config["chatglm3"]["weight_data_type"] = dtype
            ...
            config["chatglm3"]["multi_query_attention"] = (
