#ifndef __HGEMM_F32I8F32_SIMPLE_H__
#define __HGEMM_F32I8F32_SIMPLE_H__
...
//        *│      │*
//      ** │      │ **
void ig_hgemm_f32i8f32_quantize(bool transB, int N, int K, const float *B, int ldb,
        float quantization_rate, int8_t *quantizedB, int ldqb, float *scaleB, float *zeroB);

// To compute sgemm: C = alpha * A * (int8_t *)B + beta * C
void ig_hgemm_f32i8f32(bool transA, bool transB, int M, int N, int K,
...
void ig_hgemm_f32i8f32_packb(bool transB, int N, int K, const int8_t *quantizedB, int ldb, int8_t *packedB);

// To compute sgemm: C = alpha * A * (int8_t *)packedB + beta * C
// Note: there is no ldb, as B is packed in compact format
void ig_hgemm_f32i8f32_compute(bool transA, int M, int N, int K,
...
void ig_hgemm_f32i8f32_compute_silu(bool transA, int M, int N, int K,
        float alpha, const float *A, int lda, const int8_t *packedB, const float *scaleB, const float *zeroB,
        float beta, float *C, int ldc);
...
void ig_hgemm_f32i8f32_compute_resext(bool transA, int M, int N, int K,
        float alpha, const float *A, int lda, const int8_t *packedB, const float *scaleB, const float *zeroB,
...
// ldres, residential matrix stride
void ig_hgemm_f32i8f32_compute_resmul(bool transA, int M, int N, int K,
        float alpha, const float *A, int lda, const int8_t *packedB, const float *scaleB, const float *zeroB,
        float beta, float *C, int ldc, const float *res, int ldres);

// To compute sgemm w/ bias_add: C = alpha * A * (int8_t *)packedB + beta * C + bias
void ig_hgemm_f32i8f32_compute_biasadd(bool transA, int M, int N, int K,
        float alpha, const float *A, int lda, const int8_t *packedB, const float *scaleB, const float *zeroB,
        float beta, float *C, int ldc, const float *bias);

// To compute sgemm w/ bias_add: C = RELU(alpha * A * (int8_t *)packedB + beta * C + bias)
void ig_hgemm_f32i8f32_compute_biasadd_relu(bool transA, int M, int N, int K,
        float alpha, const float *A, int lda, const int8_t *packedB, const float *scaleB, const float *zeroB,
        float beta, float *C, int ldc, const float *bias);

// C = alpha * A * (int8_t *)packedB + beta * C + bias + res
// ldres, redidential matrix stride
void ig_hgemm_f32i8f32_compute_residential(bool transA, int M, int N, int K,
        float alpha, const float *A, int lda, const int8_t *packedB, const float *scaleB, const float *zeroB,
...
// ================================================================================
void small_hgemm_f32i8f32(int M, int N, int K, const float *A, int lda,
