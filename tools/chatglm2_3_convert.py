"""
Convert huggingface ChatGLM model. Use https://huggingface.co/THUDM/chatglm2_3-6b or https://huggingface.co/THUDM/chatglm3-6b
"""
...
def split_and_convert(args):
    ...
    try:
        ...
        config["chatglm2_3"]["has_post_decoder_layernorm"] = "1" if str(hf_config["post_layer_norm"]) == "True" else "0"
        ...
        config["chatglm2_3"]["weight_data_type"] = args.weight_data_type
        ...
        config["chatglm2_3"]["multi_query_attention"] = "1" if str(hf_config["multi_query_attention"]) == "True" else "0"
