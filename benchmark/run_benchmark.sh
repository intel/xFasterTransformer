...
do	
	case $1 in
        ...
        -d | --dtype)
		case $2 in
            "bf16" | "bf16_fp16" | "bf16_int8" | "int8" | "fp16" | "bf16_int4" | "int4" | "bf16_nf4" | "nf4" | "w8a8" | "bf16_w8a8")
            dtype=$2
            shift 2
            ;;
            *)
            echo "dtype must in bf16, bf16_fp16, bf16_int8, int8, fp16, bf16_int4, bf16_nf4, nf4."
            exit 1
            ;;
        esac
        ;;
