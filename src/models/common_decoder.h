...
protected:
    ...
    DecoderContext *getDecoderContext(int layers, const int hiddenSize, const int attHeadNum, const int kvHeadNum,
        ...
        if (context != nullptr) {
            ...
            this->context.reset(
                    new DecoderContext(layers, hiddenSize, attHeadNum, kvHeadNum, imSize, act, epsilon, vocabSize,
                            embeddingSize, maxPositions, maxPosEmbed, maxSeqLength, splitIdx, splits, ropeParamsPtr));
        }
