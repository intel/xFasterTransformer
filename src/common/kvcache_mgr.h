...
public:
    ...
    virtual bool isExist(int seqID) const = 0;
...
public:
    ...
    bool isExist(int seqID) const override { return sequenceCaches.find(seqID) != sequenceCaches.end(); }
...
public:
    ...
    bool isExist(int seqID) const { return cacheMgrImpl->isExist(seqID); }
